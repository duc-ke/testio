...
Status: Completed
Tags: BI, IT
파일 업로드: /assets/images/posts/a2022_04_13_snakemake/snakemake_190511.pptx, /assets/images/posts/a2022_04_13_snakemake/snakemake_advanced_190511.pptx

# Snakemake의 출범

![/assets/images/posts/a2022_04_13_snakemake/Untitled.png](/assets/images/posts/a2022_04_13_snakemake/Untitled.png)
...
- 샘플 분석 병렬화 가능 (threads opt 지원)
    ...
    ![/assets/images/posts/a2022_04_13_snakemake/Untitled%201.png](/assets/images/posts/a2022_04_13_snakemake/Untitled%201.png)
    
- 위 처럼 작업흐름도 생성(DAG)
    
    
    ![/assets/images/posts/a2022_04_13_snakemake/Untitled%202.png](/assets/images/posts/a2022_04_13_snakemake/Untitled%202.png)
...
4. 파이프라인을 구조화 시켜 쓸수 있는 장점. 
    ...
    ![/assets/images/posts/a2022_04_13_snakemake/Untitled%203.png](/assets/images/posts/a2022_04_13_snakemake/Untitled%203.png)
...
[/assets/images/posts/a2022_04_13_snakemake/snakemake_190511.pdf](/assets/images/posts/a2022_04_13_snakemake/snakemake_190511.pdf)
...
[/assets/images/posts/a2022_04_13_snakemake/snakemake_advanced_190511.pdf](/assets/images/posts/a2022_04_13_snakemake/snakemake_advanced_190511.pdf)
...
- 준비
    ...
    ![environment.yaml 파일안에는..](/assets/images/posts/a2022_04_13_snakemake/Untitled%204.png)
...
- mapping snakemake 작성
    ...
    - mapping rule 작성.
        ...
        ![rule의 기본 형태](/assets/images/posts/a2022_04_13_snakemake/Untitled%205.png)
        
        rule의 기본 형태
        
    - 해당 룰의 input파일과 생성 파일을 적고 실행 커맨드를 명시한다
    
    ![/assets/images/posts/a2022_04_13_snakemake/Untitled%206.png](/assets/images/posts/a2022_04_13_snakemake/Untitled%206.png)
    
    - shell에서 변수로 바꿀 수 있는 부분을 와일드 카드로교체 한다.
    
    ![/assets/images/posts/a2022_04_13_snakemake/Untitled%207.png](/assets/images/posts/a2022_04_13_snakemake/Untitled%207.png)
...
- mapping snakemake 업그레이드
    ...
    ![/assets/images/posts/a2022_04_13_snakemake/Untitled%208.png](/assets/images/posts/a2022_04_13_snakemake/Untitled%208.png)
    ...
    ![aaa.png](/assets/images/posts/a2022_04_13_snakemake/a_2019_11_01__12_55_29.png)
...
- sorting snakemake 작성
    - mapping을 했으니 bam을 sorting 하는 rule을 만들어 본다. 마찬가지, 형태부터 잡는다.
        ...
        ![/assets/images/posts/a2022_04_13_snakemake/_2019-11-01__1.06.07.png](/assets/images/posts/a2022_04_13_snakemake/_2019-11-01__1.06.07.png)
        
    - 이번 input이 뭔지 생각해보고 채운다.
        
        ![/assets/images/posts/a2022_04_13_snakemake/_2019-11-01__1.07.44.png](/assets/images/posts/a2022_04_13_snakemake/_2019-11-01__1.07.44.png)
        
    - samtools로 sorting하는 코드는 길다. 길땐 요렇게 쓰면 이쁘다.
        
        ![/assets/images/posts/a2022_04_13_snakemake/_2019-11-01__1.09.48.png](/assets/images/posts/a2022_04_13_snakemake/_2019-11-01__1.09.48.png)
        
    - 완성.
        
        ![/assets/images/posts/a2022_04_13_snakemake/_2019-11-01__1.33.57.png](/assets/images/posts/a2022_04_13_snakemake/_2019-11-01__1.33.57.png)
    ...
    - 이유는 shell 구문에선 현재 rule밖의 wildcard에 진입이 불가능 하기 때문이다. 문법을 조금 고쳐 주면 된다.
        ...
        ![/assets/images/posts/a2022_04_13_snakemake/_2019-11-01__1.36.21.png](/assets/images/posts/a2022_04_13_snakemake/_2019-11-01__1.36.21.png)
...
- index snakemake 작성
    - calling 전엔 bam의 index파일을 생성 해야 한다. input과 output이 뭔지 곰곰이 생각하며 룰을 추가 해본다.
        ...
        ![/assets/images/posts/a2022_04_13_snakemake/_2019-11-01__1.41.38.png](/assets/images/posts/a2022_04_13_snakemake/_2019-11-01__1.41.38.png)
...
- calling snakemake 작성
    ...
    - 위의 스크립트를 rule로 만들어 보자. 아마 input부터 막힐 것이나 그런 부분은 물음표(??)로 적어 두고 채울 수 있는 곳부터 채워 보자.
        - 아래처럼 채웠으면 아주 잘 따라 오고 있다는 것이다.
            ...
            ![/assets/images/posts/a2022_04_13_snakemake/_2019-11-01__1.56.17.png](/assets/images/posts/a2022_04_13_snakemake/_2019-11-01__1.56.17.png)
            
    - 우선 input과 output에는 하위 변수를 설정하여 파일마다 변수에 할당 할수 있다. 여러개인 경우 쉼표(,)를 꼭! 적어 줘야 한다. 변수 할당시 '.' 을 이용하여 변수에 접근 가능하다.
        
        ![/assets/images/posts/a2022_04_13_snakemake/_2019-11-01__2.01.35.png](/assets/images/posts/a2022_04_13_snakemake/_2019-11-01__2.01.35.png)
        
    - 위의 코드는 A, B까지만 동작하며 A, B, C에 대해선 동작하지 않을 것이다. 이럴경우 snakemake에서 제공하는 expand 함수를 이용해야 한다.
        
        ![/assets/images/posts/a2022_04_13_snakemake/_2019-11-01__2.07.42.png](/assets/images/posts/a2022_04_13_snakemake/_2019-11-01__2.07.42.png)
    ...
    - 생성된 svg는 브라우저로 확인할 수 있다.
        ...
        ![/assets/images/posts/a2022_04_13_snakemake/_2019-11-01__3.06.43.png](/assets/images/posts/a2022_04_13_snakemake/_2019-11-01__3.06.43.png)
    ...
    - snakemake에서는 input과 output이 서로 연결되어야 파이프라인으로 rule들이 이어진 다는 것을 눈치 챘을 텐데, 그렇다면 index는 어디에 위치 시켜야 할까?
        ...
        ![/assets/images/posts/a2022_04_13_snakemake/_2019-11-01__3.13.50.png](/assets/images/posts/a2022_04_13_snakemake/_2019-11-01__3.13.50.png)
        
    - 완성 된 모양을 DAG로 확인해 보자.
        
        ![/assets/images/posts/a2022_04_13_snakemake/_2019-11-01__3.14.38.png](/assets/images/posts/a2022_04_13_snakemake/_2019-11-01__3.14.38.png)
...
- 타겟 rule 작성
    ...
    - 아래와 같이 스크립트 맨위에 rule all을 코딩 해보자.
        ...
        ![/assets/images/posts/a2022_04_13_snakemake/_2019-11-01__3.26.28.png](/assets/images/posts/a2022_04_13_snakemake/_2019-11-01__3.26.28.png)
...
- 만들어진 전체 파이프라인을 보면 다음과 같다.
    ...
    ![/assets/images/posts/a2022_04_13_snakemake/_2019-11-01__3.30.18.png](/assets/images/posts/a2022_04_13_snakemake/_2019-11-01__3.30.18.png)
    
- 다양한 기능들이 있는데 하나만 더 써보자
    - bio tool들은 thread를 고려해서 만드는것 들이 많다.
    - bwa  툴이 그렇다.  mapping 룰에서 thread를 지원가능하다.  -t
        
        ![/assets/images/posts/a2022_04_13_snakemake/_2019-11-01__3.52.18.png](/assets/images/posts/a2022_04_13_snakemake/_2019-11-01__3.52.18.png)
        
    - snakemake에선 요렇게 하지 말고 아래 처럼 예약어를 이용하여 수정하는 것이  좋다.
        
        ![/assets/images/posts/a2022_04_13_snakemake/_2019-11-01__3.54.55.png](/assets/images/posts/a2022_04_13_snakemake/_2019-11-01__3.54.55.png)
        
    
- 완성본 업로드 :
    
    [Snakefile](/assets/images/posts/a2022_04_13_snakemake/Snakefile.txt)
